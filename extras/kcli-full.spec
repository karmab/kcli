...
Requires:       python3 libvirt-python3 genisoimage nmap-ncat python3-prettytable python3-PyYAML python3-flask python3-netaddr python3-docker python3-kubernetes python3-google-api-client python3-boto3 python3-requests python3-protobuf python-boto3
