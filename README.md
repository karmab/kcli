...
This keyword will be a fun name based on this cool python project: [name generator](https://github.com/shamrin/namesgenerator), which emulates Docker conatiner names :).
