...
wget -O /root/oc.tar.gz https://github.com/openshift/origin/releases/download/v3.8.0-alpha.0/openshift-origin-client-tools-v3.8.0-alpha.0-TOCHANGE-linux-64bit.tar.gz
