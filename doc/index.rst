...
-  Plans
-  Ansible Inventory
-  Support for scripts in the profile kboumedh@beyonder
   ~/C/g/K/k/changelog (master)> ls changelog.md v8.11.md v8.12.md
   v9.0.md v9.1.md v9.2.md v9.3.md kboumedh@beyonder ~/C/g/K/k/changelog
   (master)> vi changelog.md kboumedh@beyonder ~/C/g/K/k/changelog
   (master)> pwd /Users/kboumedh/CODE/git/KARIM/kcli/changelog
