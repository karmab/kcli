...
def cli():
    ...
    proxmoxhostcreate_parser.add_argument('-u', '--user', help='User. Default to root@pam', metavar='USER', default='root@pam')
    ...
    proxmoxhostcreate_parser.add_argument('--node', help='Cluster node where VMs will be created. Default to HOST', metavar='NODE')
