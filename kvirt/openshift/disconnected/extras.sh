images="quay.io/karmab/curl:latest quay.io/openshift/origin-coredns:latest quay.io/karmab/haproxy:latest quay.io/openshift/origin-keepalived-ipfailover:latest quay.io/openshift-metal3/mdns-publisher:latest quay.io/karmab/nginx:alpine quay.io/karmab/kubectl:latest"
