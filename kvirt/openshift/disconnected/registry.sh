...
export OPENSHIFT_RELEASE_IMAGE={{ openshift_image|default('registry.svc.ci.openshift.org/ocp/release:4.6') }}
...
echo $REGISTRY_NAME:5000/ocp/release:$OPENSHIFT_VERSION > /root/version.txt
